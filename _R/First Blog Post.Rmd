...
```{r,message=FALSE,fig.align='center',fig.height=6,fig.width=15}
...
```{r, cache=TRUE,message=FALSE,fig.align='center',fig.height=6,fig.width=15}
`Daily Load Profiles`=ggplot()+
...
```{r, cache=TRUE,message=FALSE,fig.align='center',fig.height=10,fig.width=15}
...
```{r, cache=TRUE,message=FALSE,fig.align='center',fig.height=5,fig.width=10}
